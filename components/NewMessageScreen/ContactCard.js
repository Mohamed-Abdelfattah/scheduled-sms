...
export default function ContactCard({ data, closeModal }) {
  // console.log(data);
  const { saveChanges, state } = useAppStateContext();
  ...
  const selectHandler = (number) => {
    ...
    saveChanges({ recipients: [...state.messageFormData.recipients, contact] });
